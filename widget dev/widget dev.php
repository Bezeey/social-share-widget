...
define( 'widget_dev', dirname( __FILE__ ) );
define( 'widget_dev_URL', plugins_url( '', __FILE__ ) );
 ...
 */
function widget_dev_social_profiles() {

	// return a filterable social profiles.
	return apply_filters(
		'widget_dev_social_profiles',
		array()
	);
 ...
 */
function widget_dev_register_default_social_profiles( $profiles ) {

	// add the facebook profile.
	$profiles['facebook'] = array(
		'id'                => 'widget_dev_facebook_url',
...
add_filter( 'widget_dev_social_profiles', 'widget_dev_register_default_social_profiles', 10, 1 );
 ...
 */
function widget_dev_register_social_customizer_settings( $wp_customize ) {
...
add_action( 'customize_register', 'widget_dev_register_social_customizer_settings' );
...
add_action( 'widgets_init', 'widget_dev_register_social_icons_widget' );

/**
 * Extend the widgets class for our new social icons widget.
 */
class widget_dev_Social_Icons_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$control_ops = array(
			'id_base' => 'widget_dev_social_icons',
		);

		/* Create the widget. */
		parent::__construct( 'widget_dev_social_icons', 'Social Icons', $widget_ops, $control_ops );
	...
	public function widget( $args, $instance ) {
		 ...
		 *
		 * @hooked widget_dev_social_icons_output_widget_title.- 10
		 * @hooked widget_dev_output_social_icons_widget_content - 20
		 */
		do_action( 'widget_dev_social_icons_widget_output', $args, $instance );
...
add_action( 'widget_dev_social_icons_widget_output', 'widget_dev_social_icons_output_widget_title', 10, 2 );
...
add_action( 'widget_dev_social_icons_widget_output', 'widget_dev_output_social_icons_widget_content', 20, 2 );